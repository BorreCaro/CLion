...
void reportes(int N, vector<long> identificaciones, vector<int> edad, vector<int> nivel_ac, vector<int> exp_lab, vector<int> puntaje_pt, vector<int> puntaje_e, vector<int> puntaje_max, vector<string> nombres, float suma);
void listado(int N, const vector<string>& nombres, const vector<long>& identificaciones, const vector<int>& edad, const vector<int>& nivel_ac, const vector<int>& exp_lab, const vector<int>& puntaje_pt, const vector<int>& puntaje_e, vector<int> puntaje_max);
void ordenado(int N, vector<string> nombres, vector<long> identificaciones, vector<int> edad, vector<int> nivel_ac, vector<int> exp_lab, vector<int> puntaje_pt, vector<int> puntaje_e, vector<int> puntaje_max, float suma);
void consulta(int N, vector<string> nombres, vector<long> identificaciones, vector<int> edad, vector<int> nivel_ac, vector<int> exp_lab, vector<int> puntaje_pt, vector<int> puntaje_e, vector<int> puntaje_max);
...
int main()
{
    ...
    do
    {
        ...
        case 2:
            {
                ...
                gotoxy(x1, y1++); cout<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(25, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<endl;
                gotoxy(x1, y1++); cout<<"| "<<left<<setw(19)<<"Aspirante"<<"| "<<setw(19)<<"Nombre"<<"| "<<setw(19)<<"Nivel Academico"<<"| "<<setw(24)<<"Años de Experiencia"<<"| "<<setw(19)<<"Prueba Tecnica"<<"| "<<setw(19)<<"Entrevista"<<"| "<<setw(19)<< "Total"<<"|"<<endl;
                gotoxy(x1, y1++); cout<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(25, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<endl;
                ...
                for (int j=0;x<=&nivel_ac[N-1]; x++, j++)
                {
                    ...
                    gotoxy(x1, y1++); cout<<"| "<<left<<setw(19)<<j+1<<"| "<<left<<setw(19)<<nombres[j]<<"| "<<setw(19)<<pna<<"| "<<setw(24)<<pae<<"| "<<setw(19)<<ppt<<"| "<<setw(19)<<pe<<"| "<<setw(19)<<puntaje_max[j]<<"| "<<endl;
        ...
        case 3: reportes(N, identificaciones, edad, nivel_ac, exp_lab, puntaje_pt, puntaje_e, puntaje_max, nombres, suma); break;
...
void reportes(int N, const vector<long> identificaciones, const vector<int> edad, const vector<int> nivel_ac, const vector<int> exp_lab, const vector<int> puntaje_pt, const vector<int> puntaje_e, const vector<int> puntaje_max, const vector<string> nombres, float suma)
{
    ...
    switch (opcion)
    {
        case 'A': listado(N, nombres, identificaciones, edad, nivel_ac, exp_lab, puntaje_pt, puntaje_e, puntaje_max); break;
        case 'B': ordenado(N, nombres, identificaciones, edad, nivel_ac, exp_lab, puntaje_pt, puntaje_e, puntaje_max, suma); break;
        case 'C': consulta(N, nombres, identificaciones, edad, nivel_ac, exp_lab, puntaje_pt, puntaje_e, puntaje_max); break;
    }
...
void listado(int N, const vector<string>& nombres, const vector<long>& identificaciones, const vector<int>& edad, const vector<int>& nivel_ac, const vector<int>& exp_lab, const vector<int>& puntaje_pt, const vector<int>& puntaje_e, vector<int> puntaje_max)
{
    int *p=&puntaje_max[0], i=0, max=0, mx=0;
    ...
    for (; p<=&puntaje_max[N-1]; p++, i++)
    {
        ...
        gotoxy(x, y++); cout<<"| "<<left<<setw(19)<<i+1<<"| "<<left<<setw(19)<<nombres[i]<<"| "<<setw(19)<<identificaciones[i]<<"| "<<setw(19)<<edad[i]<<"| "<<setw(19)<<nivel_ac[i]<<"| "<<setw(19)<<exp_lab[i]<<"| "<<setw(19)<<puntaje_pt[i]<<"| "<<setw(19)<<puntaje_e[i]<<"| "<<setw(19)<<puntaje_max[i]<<"| "<<endl;
    }
    gotoxy(x, y++); cout<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+";
...
void ordenado(int N, vector<string> nombres, vector<long> identificaciones, vector<int> edad, vector<int> nivel_ac, vector<int> exp_lab, vector<int> puntaje_pt, vector<int> puntaje_e, vector<int> puntaje_max, float suma)
{
    ...
    {
        for (x=&puntaje_max[0]; x<&puntaje_max[N-1]; x++, a++, b++, c++, d++, e++, f++, g++, h++)
        {
            if (*x>(suma/N)) mayor++;
    ...
    {
        gotoxy(x1, y++); cout<<"| "<<left<<setw(19)<<i+1<<"| "<<left<<setw(19)<<nombres[i]<<"| "<<setw(19)<<identificaciones[i]<<"| "<<setw(19)<<edad[i]<<"| "<<setw(19)<<nivel_ac[i]<<"| "<<setw(19)<<exp_lab[i]<<"| "<<setw(19)<<puntaje_pt[i]<<"| "<<setw(19)<<puntaje_e[i]<<"| "<<setw(19)<<puntaje_max[i]<<"| "<<endl;
    }
    gotoxy(x1, y++); cout<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<string(20, '-')<<"+"<<endl;
    ...
    gotoxy(x1, y++); cout<<"+"<<string(20, '-')<<"+"<<string(40, '-')<<"+"<<endl;
    gotoxy(x1, y++); cout<<"| "<<left<<setw(19)<<"Puntaje promedio"<<"| "<<setw(39)<<"Aspirantes por encima del promedio"<<"| "<<endl;
    gotoxy(x1, y++); cout<<"+"<<string(20, '-')<<"+"<<string(40, '-')<<"+"<<endl;
    gotoxy(x1, y++); cout<<"| "<<left<<setw(19)<<suma/N<<"| "<<left<<setw(39)<<mayor<<"| "<<endl;
    gotoxy(x1, y++); cout<<"+"<<string(20, '-')<<"+"<<string(40, '-')<<"+"<<endl;
